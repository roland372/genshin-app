	...
	return (
		<CardComponent title='Past Banners'>
			...
			<section>
				...
				<BannerHeading>
					{props.bannersData.pastBanners['version 2.5'].map((e, index) => {
						return (
							<BannerItem
								key={index}
								name={e.name}
			...
			<section>
				...
				<BannerHeading>
					{props.bannersData.pastBanners['version 2.4'].map((e, index) => {
						return (
							<BannerItem
								key={index}
								name={e.name}
			...
			<section>
				...
				<BannerHeading>
					{props.bannersData.pastBanners['version 2.3'].map((e, index) => {
						return (
							<BannerItem
								key={index}
								name={e.name}
