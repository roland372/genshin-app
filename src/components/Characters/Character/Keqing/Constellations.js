		...
		<ConstellationsWrapper>
			<Constellation
				...
				description={
					<div>
						...
						causes Keqing to deal 50% of her ATK as
				...
				description={
					<div>
						<div>
							...
							<b className='text-electro'> Electro</b>, they have a 50% chance
							of producing an Elemental Particle.
						</div>
			...
			<Constellation
				...
				description={
					<div>
						<div>
							When initiating a Normal Attack, a Charged Attack, Elemental Skill
							or Elemental Burst, Keqing gains a 6%
							<b className='text-electro'> Electro DMG Bonus </b>
							for 8s.
						</div>
						<div>
							Effects triggered by Normal Attacks, Charged Attacks, Elemental
							Skills and Elemental Bursts are considered independent entities.
						</div>
					</div>
				}
			/>
