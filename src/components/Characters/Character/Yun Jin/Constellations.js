	...
	return (
		<ConstellationsWrapper>
			...
			<Constellation
				...
				description={
					<div>
						After Cliffbreaker's Banner is unleashed, all nearby party members'
						Normal Attack DMG is increased by 15% for 12s.
					</div>
				}
			/>
			<Constellation
				...
				description={
					<div>
						<div>Increases the Level of Cliffbreaker's Banner by 3.</div>
			...
			<Constellation
				...
				description={
					<div>
						<div>Increases the Level of Opening Flourish by 3.</div>
						<div>Maximum upgrade level is 15.</div>
					</div>
				}
			/>
