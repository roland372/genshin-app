						...
						<tbody>
							...
							<Constellation
								...
								description={
									<div>
										<div>
											Increases the Blood Blossom DMG by an amount equal to 10%
											of Hu Tao's Max HP at the time the effect is applied.
										</div>
										<div>
								...
								description={
									<div>
										<div>
											...
											suffers a lethal strike:
										</div>
										<div>
											Hu Tao will not fall as a result of the DMG sustained.
											Additionally, for the next 10s, all of her Elemental and
											Physical RES is increased by 200%, her CRIT Rate is
											increased by 100%, and her resistance to interruption is
											greatly increased.
										</div>
										<div>
											This effect triggers automatically when Hu Tao has 1 HP
											left.
										</div>
