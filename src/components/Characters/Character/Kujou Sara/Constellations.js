						...
						<tbody>
							<Constellation
								...
								description={
									<div>
										<div>
											When Tengu Juurai grant characters ATK Bonuses or hits
											opponents, the CD of Tengu Stormcall is decreased by 1s.
										</div>
							...
							<Constellation
								...
								description={
									<div>
										Unleashing Tengu Stormcall will leave a weaker Crowfeather
										at Kujou Sara's original position that will deal 30% of its
										original DMG.
									</div>
								}
							/>
