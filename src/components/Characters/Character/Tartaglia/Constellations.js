						...
						<tbody>
							...
							<Constellation
								...
								description={
									<div>
										<div>
											If Tartaglia is in Foul Legacy: Raging Tide's Melee
											Stance, triggers Riptide Slash against opponents on the
											field affected by Riptide every 4s, otherwise, triggers
											Riptide Flash.
										</div>
										<div>
											Riptide Slashes and Riptide Flashes triggered by this
											Constellation effect are not subject to the time intervals
											that would typically apply to these two Riptide effects,
							...
							<Constellation
								...
								description={
									<div>
										<div>
											When Havoc: Obliteration is cast in Melee Stance, the CD
											of Foul Legacy: Raging Tide is reset.
										</div>
										<div>
											This effect will only take place once Tartaglia returns to
											his Ranged Stance.
										</div>
									</div>
								}
