					...
					<table className='table table-dark table-sm align-middle'>
						...
						<tbody>
							...
							<Constellation
								...
								description={
									<div>
										The duration of the Ice Lance created by Rites of
										Termination is increased by 4s.
									</div>
								}
							/>
							<Constellation
							...
							<Constellation
								...
								description={
									<div>
										<div>
											Ravaging Confession's CRIT Hits regenerate 5 Energy for
											Rosaria.
										</div>
										<div>
											Can only be triggered once each time Ravaging Confession
											is cast.
										</div>
									</div>
								}
