	...
	return (
		<ConstellationsWrapper>
			...
			<Constellation
				...
				description={
					<div>
						When Falling Thunder created by Bellowing Thunder hits an opponent,
			...
			<Constellation
				...
				description={
					<div>
						...
						Blade, if this character's Energy is less than 35%, the Energy
						restored by the Abundance Amulets is increased by 100%.
					</div>
				}
			/>
			<Constellation
			...
			<Constellation
				...
				description={
					<div>
						...
						dealing 200% of its original DMG, and will restore an additional 1
						Energy to the current character.
					</div>
				}
			/>
		</ConstellationsWrapper>
