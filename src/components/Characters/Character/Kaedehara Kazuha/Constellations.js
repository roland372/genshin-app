						...
						<tbody>
							...
							<Constellation
								...
								description={
									<div>
										...
										<ul>
											<li>
												Increases Kaedehara Kazuha's own Elemental Mastery by
												200.
											</li>
											<li>
												Increases the Elemental Mastery of characters within the
												field by 200.
											</li>
										</ul>
										<div>
											The Elemental Mastery-increasing effects of this
											Constellation do not stack.
										</div>
									</div>
								}
							/>
							...
							<Constellation
								...
								description={
									<div>
										<div>
											When Kaedehara Kazuha's Energy is lower than 45, he
											obtains the following effects:
										</div>
										<ul>
											<li>
												Pressing or Holding Chihayaburu regenerates 3 or 4
												Energy for Kaedehara Kazuha, respectively.
											</li>
											<li>
												When gliding, Kaedehara Kazuha regenerates 2 Energy per
												second.
											</li>
										</ul>
									</div>
