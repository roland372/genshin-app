	...
	return (
		<ConstellationsWrapper>
			...
			<Constellation
				...
				description={
					<div>
						While General's Glory is in effect, its duration is extended by 1s
						when a nearby active character obtains an Elemental Shard from a
						Crystallize reaction. This effect can occur once every 0.1s. Max
						extension is 3s.
					</div>
				}
			/>
			<Constellation
				...
				description={
					<div>
						<div>Increases the Level of Inuzaka All-Round Defense by 3.</div>
			...
			<Constellation
				...
				description={
					<div>
						...
						will also heal active characters within its AoE by 50% of Gorou's
						own DEF every 1.5s.
					</div>
				}
			/>
			<Constellation
				...
				description={
					<div>
						<div>Increases the Level of Juuga: Forward Unto Victory by 3.</div>
						<div>Maximum upgrade level is 15.</div>
					</div>
				}
			/>
			<Constellation
				...
				description={
					<div>
						...
						Victory, increases the CRIT DMG of all nearby party members'
						<b className='text-geo'> Geo DMG </b>
						...
						This effect cannot stack and will take reference from the last
						instance of the effect that is triggered.
					</div>
				}
			/>
		</ConstellationsWrapper>
