		...
		<ConstellationsWrapper>
			...
			<Constellation
				...
				description={
					<div>
						<div>
							Increases Icy Paws' DMG by 15%, and increases its shield's DMG
							Absorption by 15%.
						</div>
						<div>
							Additionally, when paws hit their targets, creates a shield for
							other nearby characters on the field with 50% of the Icy Paws
			...
			<Constellation
				...
				description={
					<div>
						...
						<ul>
							<li>
								Increases Incoming Healing Bonus by 30% when HP falls below or
								is equal to 50%.
							</li>
