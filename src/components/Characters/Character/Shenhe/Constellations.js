					...
					<table className='table table-dark table-sm align-middle'>
						...
						<tbody>
							...
							<Constellation
								...
								description={
									<div>
										...
										<div>
											Active characters within the skill's field deals 15%
											increased <b className='text-cryo'>Cryo</b> CRIT DMG.
										</div>
									</div>
								}
							/>
							...
							<Constellation
								...
								description={
									<div>
										When characters under the effect of Icy Quill applied by
										Shenhe triggers its DMG Bonus effects, Shenhe will gain a
										Skyfrost Mantra stack:
										<ul>
											<li>
												When Shenhe uses Spring Spirit Summoning, she will
												consume all stacks of Skyfrost Mantra, increasing the
												DMG of that Spring Spirit Summoning by 5% for each stack
												consumed.
											</li>
