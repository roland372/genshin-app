	...
	return (
		<ConstellationsWrapper>
			<Constellation
				...
				description={
					<div>
						...
						<div>
							Each stack consumed will increase the duration of this effect by
							6s up to a maximum of 18s.
						</div>
					</div>
				}
			/>
			<Constellation
				...
				description={
					<div>
						Decreases the CD of Icetide Vortex's Holding Mode, rendering it
						identical to Tapping CD.
					</div>
				}
			/>
			<Constellation
