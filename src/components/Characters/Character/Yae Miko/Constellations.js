					...
					<table className='table table-dark table-sm align-middle'>
						...
						<tbody>
							...
							<Constellation
								...
								description={
									<div>
										Sesshou Sakura start at Level 2 when created, their max
										level is increased to 4, and their attack range is increased
										by 60%.
									</div>
								}
							/>
							<Constellation
								...
								description={
									<div>
										<div>
											Increases the Level of Yakan Evocation: Sesshou Sakura by
											3.
										</div>
							...
							<Constellation
								...
								description={
									<div>
										<div>
											Increases the Level of Great Secret Art: Tenko Kenshin by
											3.
										</div>
										<div>Maximum upgrade level is 15.</div>
									</div>
