		...
		<ConstellationsWrapper>
			<Constellation
				...
				description={
					<div>
						<div>
							Upon scoring a CRIT Hit, increases ATK SPD of Xinyan's Normal and
							Charged Attacks by 12% for 5s.
						</div>
			...
			<Constellation
				...
				description={
					<div>
						Riff Revolution's Physical DMG has its CRIT Rate increased by 100%,
						and will form a shield at Shield Level 3: Rave when cast.
					</div>
				}
			/>
			<Constellation
