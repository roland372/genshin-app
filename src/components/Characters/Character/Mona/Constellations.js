	...
	return (
		<ConstellationsWrapper>
				...
				description={
					<div>
						<div>
							...
							Omen, the effects of
							<b className='text-hydro'> Hydro-related Elemental Reactions </b>
							are enhanced for 8s:
						</div>
						<ul>
				...
				description={
					<div>
						<div>
							...
							automatically followed by a Charged Attack.
						</div>
			...
			<Constellation
				...
				description={
					<div>
						<div>Increases the Level of Mirror Reflection of Doom by 3.</div>
						<div>Maximum upgrade level is 15.</div>
					</div>
				}
			/>
			<Constellation
				...
				description={
					<div>
						<div>
							Upon entering Illusory Torrent, Mona gains a 60% increase to the
							DMG of her next Charged Attack per second of movement.
						</div>
						<div>
							A maximum DMG Bonus of 180% can be achieved in this manner. The
							effect lasts for no more than 8s.
						</div>
					</div>
				}
			/>
