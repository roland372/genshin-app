	...
	return (
		<CardComponent title='Talents'>
			<NormalAttack
				...
				normalAttack={<div>Perform up to 5 successive strikes.</div>}
				chargedAttack={
					<div>
						Drains Stamina over time to perform continuous slashes. At end of
						the sequence, perform a more powerful slash.
					</div>
				}
				plungingAttack={
					<div>
