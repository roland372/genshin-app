			...
			<CardComponent title={name}>
				...
				<div className='mx-2'>
					<section className='rounded-top p-3 bg-primary-light'>
						<h5 className='mt-1'>Level {levelHigh}</h5>
					</section>
					...
					<section className='rounded-top p-3 bg-primary-light'>
						<h5 className='me-2'>Talents</h5>
					</section>
					{/* <----- Talents -----> */}
					<section className='rounded bg-primary-dark'>
						<section className='d-flex flex-column text-color'>
							{/* <----- normal attack -----> */}
							{materialsData.map(c =>
								name === c.data.name ? (
									<div
										className='d-flex align-items-center justify-content-between rounded p-2 mx-3 mt-3 bg-secondary-medium'
										key={c.data.name}
									>
							...
							{materialsData.map(c =>
								name === c.data.name ? (
									<div
										className='d-flex align-items-center justify-content-between rounded p-2 m-3 bg-secondary-medium'
										key={c.data.name}
									>
										<div className='d-flex align-items-center'>
											<img
							...
							{materialsData.map(c =>
								name === c.data.name ? (
									<div
										className='d-flex align-items-center justify-content-between rounded p-2 mx-3 mb-3 bg-secondary-medium'
										key={c.data.name}
									>
