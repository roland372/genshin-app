...
import AratakiIttoData from '../assets/data/Characters/Arataki Itto.json';
...
import GorouData from '../assets/data/Characters/Gorou.json';
import HuTaoData from '../assets/data/Characters/Hu Tao.json';
import JeanData from '../assets/data/Characters/Jean.json';
...
import RazorData from '../assets/data/Characters/Razor.json';
import RosariaData from '../assets/data/Characters/Rosaria.json';
...
import XingqiuData from '../assets/data/Characters/Xingqiu.json';
...
export default charactersImports;
